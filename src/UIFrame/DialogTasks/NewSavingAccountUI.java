 ...
 * @author ACER
 */
public class NewSavingAccountUI extends javax.swing.JDialog {
     ...
     * @param customer
     */
    public NewSavingAccountUI(CustomerTasksUI customerUI, boolean modal, CustomerController customerController, CustomerModel customer) {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Create New Saving Account");
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        try {
            ...
            if (balanceText == null || balanceText.isEmpty() || Double.parseDouble(balanceText) < 100) {
                JOptionPane.showMessageDialog(rootPane, "Make sure that you input a number greater than or equal to 100!");
            } else {
                
                SavingAccountModel savingAccountModel = new SavingAccountModel();
                savingAccountModel.setBalance(Double.parseDouble(balanceText));
                savingAccountModel.setBranchID(customerController.findBranchIDByCity((String) this.cmbxBranch.getSelectedItem()));
                savingAccountModel.setInterestRate(7.5);              
                customerController.saveSavingAccount(savingAccountModel, customer.getCustomer_id());
